...
<h4>Mobile Cloud Computing, Complexity and Knowledge-Based Neurological Healthcare System</h4>
<img src="/2025/assets/images/keynote_speaker/yeliz_karaca.jpg" align="left" style="border:10px solid white" width="200">
<h5><b>Yeliz Karaca, Professor</b></h5>
<h6>
University of Massachusetts, USA
</h6>
<p style="text-align: justify;">
<b>Abstract: </b>Cloud computing, through its provision of computing services via the internet, encompasses critical constituents like storage, servers, software, networking and data analytics. Marked by its scalable and flexible nature, cloud computing systems can support operational continuity, which is of particular benefit in terms of efficient share of processing and data storage between the device and the cloud system for optimizing performance, convenience as well as security. In these regards, cloud computing and cybersecurity are complementary with each other since cloud computing involves the outsourcing of data storage to a third-party provider, whereas cybersecurity is oriented towards the protection of such data. The utilization of information technologies in medicine and healthcare has exhibited an incremental growth considering that data have become more voluminous and challenging to handle due to the fact that the data are created from different sources of devices within a short time span. Complexity, as a form of system relevant in virtually all the aspects concerning healthcare, has brought about exponential speed-up for specific problems and required the development of mechanisms capable of enabling applicable approaches to optimization, securing data transmission and modeling of complex biological systems. Therefore, it has become essential to provide a more convenient and reliable service and environment of healthcare with traceability aspects regarding Electronic Health Records (EHRs), public health-related data as well as biomedical database. These emerging trends in information technologies have resulted in the realization of a new computing model of cloud computing. A novel approach in main stroke subtypes regarding clinical and medical attributes with the use of mobile phone via the cloud system has been proposed, suggesting an applicable solution for cardioembolic/cryptogenic stroke patients. This study employs Virtual Dedicated Server (VDS) as 4 VCPU and 8 GB RAM while proposing a model based on the Android-based mobile phones for stroke patients with cardioembolic (689) and cryptogenic (528) subtypes. Accordingly, the study has included big data application, supported by Artificial Neural Network (ANN), which is the Multilayer Perceptron Algorithm (MLP), that can be used on mobile phones running Android OS with cloud computing. The system proposed aims to enhance accessibility to accurate health data and analysis for the patients while improving the accuracy rate since classification is performed by ANN clustering affordance. Other important benefits include serving to provide economic advantages due to the information being accessed directly through the user’s mobile system. The model proposed via the Knowledge-based Oriented Stroke Diagnosis Healthcare ultimately intends to considerably enhance the life quality of the stroke patients in addition to its applicability opportunity through particular adjustments for other disorders and diseases. 
</p>
<p style="text-align: justify;">
<b>Biography: </b> Yeliz Karaca is a Professor of Applied Mathematics at the Department of Mathematics and Senior Researcher Professor at the Department of Neurology at University of Massachusetts (UMass), MA, USA. She received her Ph.D. degree in Mathematics from Marmara University, Istanbul, Türkiye in 2012. Along with the other awards she has been conferred, she was granted the Cooperation in Neurological Sciences and Support Award by Turkish Neurology Association as the first mathematician in Türkiye. Besides these, she holds a medical card as the only mathematician entitled to it, as a result of the various long-term medical and clinical-related trainings she has received and been certified. Furthermore, she received the Outstanding Young Scientist Award in 2012 and Best Paper Awards in her specialized discipline, among the other national and international awards in different categories as well as grants. Another award of hers is Outstanding Reviewer Award (Mathematics Journal, MDPI) in 2021. 
<br/>
Professor Karaca is the Editor-in-Chief of the book series named Systems Science and Nonlinear Intelligence Dynamics by World Scientific, and she has been acting as the lead editor, editor and associate editor in many different SCI indexed journals. She has authored books entitled Computational Methods for Data Analysis by De Gruyter (2018), Computational and Mathematical Neuroscience, Biology & Medicine: Clinical and Medical Applications due for 2025 by Wiley-IEEE Press. She also has the following edited books: Multi-Chaos, Fractal and Multi-Fractional Artificial Intelligence of Different Complex Systems by Elsevier Intelligent Fractal-Based Image Analysis: Applications in Pattern Recognition and Machine Vision by Elsevier (2024) and Mathematical Modeling, Applied Analysis and Computational Methods by Springer (2025). She is the editor of over 25 proceeding series entitled Computational Science and Its Applications – Lecture Notes in Computer Science by Springer. She has been acting as an editor and associate editor in SCI indexed journals, some of which are Fractals Journal (WS), IEEE Access Journal and Brain X Journal (Wiley). She has many special issues in which she is the lead editor. 
<br/>
Furthermore, Professor Karaca has been involved in numerous international conferences with active roles such as a general chair, chair and co-chair.  She is the general chair of some conferences among which are the Image Processing, Wavelet and Applications (IWW) as well as International Conference on Computational Science and Its Applications 2025 (ICCSA 2025). Among her affiliated organizations in which she has active scientific roles and involvement with projects are Organization for Women in Science for the Developing World (OWSD); Complex Human Adaptive Organizations and Systems (CHAOS)- University of Perugia, Italy; Institute of Electrical and Electronics Engineer (IEEE-senior member).
<br/>
Her research interests mainly focus on complex systems sciences with applications in various terrains, applied mathematics, advanced computational methods, AI applications, computational complexity, complexity sciences, applied mathematics, cloud systems, fractals, fractional calculus, solutions of advanced mathematical challenges, mathematical neuroscience and biology as well as advanced data analysis in medicine and other related theoretical, computational and applied domains.
